...
const en: Dict = {
	...
	'bs.retake': 'retake',
	'bs.send': 'send it',
	'bs.sending': 'checking with the bullshit inspector…',
	'bs.done': 'posted. your face is now part of the record.',
	...
	'bs.reject.nudity': 'rejected: keep your clothes on.',
	'bs.reject.violence': 'rejected: no violence.',
	'bs.reject.minor': 'rejected: adults only.',
	'bs.reject.hate': 'rejected: no hate symbols.',
	'bs.reject.text': 'rejected: no text, signs or QR codes in the shot.',
	'bs.reject.noface': 'rejected: that is not a photo of you.',
	'bs.reject.manyfaces': 'rejected: only you in the frame.',
	'bs.reject.unavailable': 'the inspector is asleep. try again in a minute.',
	'read.title': 'the read',
	...
	'read.a.grifter.d': 'caps and snakes. people think there is an angle, and it is not theirs.',
...
const tr: Dict = {
	...
	'bs.send': 'gönder',
	'bs.sending': 'bullshit müfettişine soruluyor…',
	'bs.done': 'gitti. suratın artık kayıtlarda.',
	...
	'bs.wallEmpty': 'henüz bullshit yok. ilk surat sen ol.',
	...
	'bs.reject.nudity': 'reddedildi: üstünü giy.',
	'bs.reject.violence': 'reddedildi: şiddet yok.',
	'bs.reject.minor': 'reddedildi: sadece yetişkinler.',
	'bs.reject.hate': 'reddedildi: nefret sembolü yok.',
	'bs.reject.text': 'reddedildi: karede yazı, tabela ya da QR olmasın.',
	'bs.reject.noface': 'reddedildi: bu senin fotoğrafın değil.',
	'bs.reject.manyfaces': 'reddedildi: karede sadece sen.',
	'bs.reject.unavailable': 'müfettiş uyuyor. bir dakikaya tekrar dene.',
	'read.title': 'okuma',
	'read.pending': 'okuma için {n} oy lazım.',
	...
	'read.quadrant': 'insanların hissi',
	...
	'read.a.grifter.d': 'dümen ve yılan. insanlar bir hesap olduğunu düşünüyor, ve kendi lehlerine değil.',
	...
	'read.a.goat': 'goat',
	'read.a.goat.d': 'oyunun zirvesi ve kalabalık hemfikir. nadir hava.',
	'read.a.classact': 'kalite',
	'read.a.classact.d': 'sıcak ve yetkin. insanların gerçekten hayran olduğu kombinasyon.',
	'read.a.unread': 'okunamadı',
